...
export const metadata = {
  title: "Our Story • Lush Layers",
  description: "Learn about the masters, ingredients, and slow craft behind LUSH LAYERS bespoke confections.",
};
        ...
        <div className="container-lux">
          ...
          >
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", marginBottom: "0.6rem", background: "var(--bg-cream)", padding: "0.25rem 0.75rem", borderRadius: "var(--radius-full)", border: "1px solid var(--border-subtle)" }}>
              ...
              <span style={{ fontSize: "0.78rem", color: "var(--text-primary)", fontWeight: 600 }}>Location: PB Road, Kolkata-41, India</span>
            </div>
